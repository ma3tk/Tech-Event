/**
 * Sheet primitive (Radix UI Dialog ベース、shadcn/ui パターン)
 *
 * - left / right / top / bottom の 4 サイドからスライドイン
 * - モバイルのナビ用ドロワーや、絞り込みパネルに利用
 */
"use client";
  ...
  ].join(" "),
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-3/4 sm:max-w-sm border-l border-border data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
      },
    },
